...
class Ui_BoaVista(object):
    def setupUi(self, BoaVista):
        ...
        BoaVista.setEnabled(True)
        BoaVista.resize(676, 612)
        self.DB_Edit = QtGui.QWidget()
        self.DB_Edit.setMinimumSize(QtCore.QSize(0, 586))
        self.DB_Edit.setMaximumSize(QtCore.QSize(670, 16777215))
        ...
        self.tableWidget.setMaximumSize(QtCore.QSize(361, 401))
